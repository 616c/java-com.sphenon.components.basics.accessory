...
public class OSet_SingleVector_IteratorImpl_Accessory_Type_
    implements Iterator_Accessory_,
               Cloneable
{
    private java.util.Vector vector;
    private java.util.ListIterator list_iterator;
    private Accessory current_item;

    public OSet_SingleVector_IteratorImpl_Accessory_Type_ (CallContext context, java.util.Vector vector) {
        this.vector = vector;
    ...
    public void     next          (CallContext context) {
        if (this.list_iterator.hasNext()) {
            this.current_item = (Accessory) this.list_iterator.next();
        } else {
    ...
    public OSet_SingleVector_IteratorImpl_Accessory_Type_ clone(CallContext context) {
        try {
            return (OSet_SingleVector_IteratorImpl_Accessory_Type_) super.clone();
