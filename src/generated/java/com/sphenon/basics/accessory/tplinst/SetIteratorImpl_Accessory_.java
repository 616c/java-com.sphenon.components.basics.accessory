...
public class SetIteratorImpl_Accessory_
    implements Iterator_Accessory_
{
    ...
    public SetIteratorImpl_Accessory_ (CallContext context, java.util.Hashtable map) {
        this.map = map;
        ...
        if (this.iterator.hasNext()) {
            ...
            this.current = (Accessory) me.getValue();
        } else {
            this.current = null;
        }
    }
