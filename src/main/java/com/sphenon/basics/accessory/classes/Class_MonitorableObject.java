...
public class Class_MonitorableObject implements ProblemMonitor {

    public Class_MonitorableObject() {
    }

    public Class_MonitorableObject(CallContext context) {
    }

    public void initialiseClass_MonitorableObject (CallContext call_context) {
    }
    ...
    public void destroy (CallContext context) {
        if (!this.is_destroyed) {
            ...
            this.destroyClass_MonitorableObject(context);
        }
    }
    ...
    protected void destroyClass_MonitorableObject (CallContext context) {
    }
    ...
    public void validateinstanceClass_MonitorableObject(CallContext context) throws ValidationFailure {
    }
    
    protected ValidationFailure validateinstanceClass_MonitorableObject(CallContext call_context, ValidationFailure vf) {
        return vf;
    }
    ...
    // TO BE REPEATED IN E.G. MONITORABLE_CORE_OBJECT, DUE TO LACK OF MULTIPLE INHERITANCE
