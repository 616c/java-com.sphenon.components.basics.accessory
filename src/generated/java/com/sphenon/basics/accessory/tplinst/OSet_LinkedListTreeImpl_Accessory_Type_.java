...
public class OSet_LinkedListTreeImpl_Accessory_Type_
  implements OSet_Accessory_Type_ {
    protected java.util.Hashtable map;
    protected Set_LinkedListTreeImpl_Accessory_ toplevel_set;
    protected Type itemtype;


    public OSet_LinkedListTreeImpl_Accessory_Type_ (CallContext context) {
        this.map = new java.util.Hashtable ();
        this.toplevel_set = new Set_LinkedListTreeImpl_Accessory_ (context);
        this.itemtype = TypeManager.get(context, Accessory.class);
        map.put(this.itemtype, this.toplevel_set);
    }

    public OSet_LinkedListTreeImpl_Accessory_Type_ (CallContext context, java.util.Hashtable map) {
        this.map = map;
        this.toplevel_set = new Set_LinkedListTreeImpl_Accessory_ (context);
        this.itemtype = TypeManager.get(context, Accessory.class);
        map.put(this.itemtype, this.toplevel_set);
    ...
    public Accessory      getSole    (CallContext context, Type index) throws DoesNotExist, MoreThanOne {
        Set_Accessory_ set = this.get(context, index);
    ...
    public Set_Accessory_ tryGet  (CallContext context, Type index) {
        ...
        return (Set_Accessory_) map.get(index);
    }
    ...
    public Accessory      tryGetSole (CallContext context, Type index) {
        Set_Accessory_ set = this.tryGet(context, index);
    ...
    private Set_LinkedListTreeImpl_Accessory_ getEntry(CallContext context, Type index) {
        Set_LinkedListTreeImpl_Accessory_ set = (Set_LinkedListTreeImpl_Accessory_) map.get(index);
        if (set == null) {
            set = new Set_LinkedListTreeImpl_Accessory_ (context);
            map.put(index, set);
    ...
    private void    _setSuper  (CallContext context, Type index, Set_LinkedListTreeImpl_Accessory_ sllti) {
    ...
    private void    _unsetSuper  (CallContext context, Accessory item, Type index, Set_LinkedListTreeImpl_Accessory_ sllti) {
        if (index.equals(itemtype)) return;
        // Iterator_Type_ supertypes = index.getSuperTypes(context).getNavigator(context);
        Iterator_Type_ supertypes = index.getAllShortestPathSuperInterfaces(context).getNavigator(context);
        Type supertype;
    ...
    public void     set     (CallContext context, Accessory item) {
        ...
        Set_LinkedListTreeImpl_Accessory_ entry = this.getEntry(context, index);
